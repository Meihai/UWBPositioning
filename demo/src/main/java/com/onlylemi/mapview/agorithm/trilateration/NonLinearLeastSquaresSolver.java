...
public class NonLinearLeastSquaresSolver {
    ...
    public LeastSquaresOptimizer.Optimum solve(double[] target, double[] weights, double[] initialPoint, boolean debugInfo) {
        if (debugInfo) {
    ...
    public LeastSquaresOptimizer.Optimum solve(boolean debugInfo) {
