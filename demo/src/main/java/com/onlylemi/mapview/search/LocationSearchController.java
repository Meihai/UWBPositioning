...
public class LocationSearchController implements SearchController  {
    private static final int DEFAULT_DEBOUNCE = 700; // milliseconds

    private final ILocationSearch mSearch;
    ...
    @Inject
    public LocationSearchController(ILocationSearch search) {
        mSearch = search;
